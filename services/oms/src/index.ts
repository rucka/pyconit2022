...
import { authenticate, validatePayloadSignature, plugins, preflight } from '@pyconit2022/ts-shared/src/http'
import { placeOrder, processOrder } from './checkout'
import { parseUserToken  } from '@pyconit2022/ts-shared/src/http/parseUserToken'
...
server.post('/checkout', parseUserToken, authenticate, validatePayloadSignature, async (req, res) => {
  if (!req.params) {
