...
import {
  ...
  plugins,
  preflight
} from '@pyconit2022/ts-shared/src/http'
...
server.get('/invoice/:order_number', authenticate, (req, res) => {
...
server.post('/invoice', parseServiceToken, authorizeService('oms'), validatePayloadSignature, (req, res) => {
